...
ocorre em português, modelos tradicionais como o \textit{Naive Bayes}, 
que classifica textos com base em probabilidades, e redes MLP 
(\textit{Multilayer Perceptron}), que são redes neurais simples sem 
capacidade de entender o contexto das palavras, apresentam limitações 
significativas ao lidar com \textit{tickets} reais, pois não conseguem 
capturar a variabilidade semântica nem o vocabulário técnico específico 
do domínio de TI.
