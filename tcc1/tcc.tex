...
Investigar se a inclusão de uma camada de explicabilidade e grafos de co-ocorrência, a um pipeline de classificação baseado em transformers, aumenta a transparência e auditabilidade do processo decisório, em relação a abordagens sem explicabilidade, utilizando chamados de suporte de TI em português brasileiro.
